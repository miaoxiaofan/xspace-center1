...
public class AuthHelper {
    ...
    private static final String GET_ACCESSTOKEN_URL="https://oapi.dingtalk.com/gettoken?appkey=APPKEY&appsecret=APPSECRET";
    ...
    public static String getAccessToken(String appKey,String appSecret) throws Exception {
        //1.获取请求url
        String url=GET_ACCESSTOKEN_URL.replace("APPKEY", appKey).replace("APPSECRET", appSecret);
    ...
    public static Map<String, Object> getDDConfig(HttpServletRequest request){
        ...
        System.out.println("agentId:"+Env.AGENT_ID);
        System.out.println("corpId:"+Env.CORP_ID);



        //3.将配置参数存入Map
        configMap.put("agentId", Env.AGENT_ID);
    ...
    public static String getConfig(HttpServletRequest request){
        ...
        String configValue = "{jsticket:'" + ticket + "',signature:'" + signature + "',nonceStr:'" + nonceStr + "',timeStamp:'"
                + timeStamp + "',corpId:'" + Env.CORP_ID + "',agentId:'" + Env.AGENT_ID + "'}";
